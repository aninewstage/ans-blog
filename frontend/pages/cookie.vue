<template>
  <div class="site-content">
    <div class="container">
      <h1>Cookie Policy for Aninewstage Blogs</h1>

      <p>
        This is the Cookie Policy for Aninewstage Blogs, accessible from
        https://blogs.aninewstage.org
      </p>
