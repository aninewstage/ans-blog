<template>
  <div class="site-content">
    <div class="container">
      ...
      <p>Welcome to Aninewstage Blogs!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Aninewstage's Website, located at https://blogs.aninewstage.org.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Aninewstage Blogs if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Aninewstage Blogs, you agreed
        to use cookies in agreement with the Aninewstage's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Aninewstage and/or its licensors own the
        intellectual property rights for all material on Aninewstage Blogs. All
        intellectual property rights are reserved. You may access this from
        Aninewstage Blogs for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Aninewstage Blogs</li>
        <li>Sell, rent or sub-license material from Aninewstage Blogs</li>
        <li>Reproduce, duplicate or copy material from Aninewstage Blogs</li>
        <li>Redistribute content from Aninewstage Blogs</li>
      </ul>
      ...
      <p>
        ...
        Aninewstage does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Aninewstage,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Aninewstage shall not be
      ...
      <p>
        Aninewstage reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Aninewstage a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Aninewstage; and (d) the link
      ...
      <p>
        ...
        e-mail to Aninewstage. Please include your name, your organization name,
      ...
      <p>
        No use of Aninewstage's logo or other artwork will be allowed for
