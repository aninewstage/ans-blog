<template>
  <div class="site-content">
    ...
    <div class="container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Aninewstage Blogs.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Aninewstage Blogs, accessible
            from
            <a
              href="https://blogs.aninewstage.org"
              rel="external nofollow noopener"
              target="_blank"
              >https://blogs.aninewstage.org</a
            >
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: j6dr23n@gmail.com</li>
      </ul>
    </div>
  </div>
</template>
